...
import subprocess
#NO USES ESTO COMO UN CIFRADO REAL, ES EXTREMADAMENTE DEBIL
letterlist = ("1", "2", "3", "4", "5", "6", "7", "8", "9", "0", " " ,"a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "ñ", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z")
Cyphlist = ("s","t","u","v","w","x","y","z","/","%"," ","1", "2", "3", "4", "5", "6", "7", "8", "9", "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r")
